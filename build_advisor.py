...
ADAPTIVE_ITEMS = [
    ...
    dict(name="Force of Nature", slot="flex", cost=2900,
         condition=lambda t, champ: t["total_ap"] >= 3 and t["burst_magic"] == 0,
